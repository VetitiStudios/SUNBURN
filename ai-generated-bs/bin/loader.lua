...
function loader.init()
    ...
    elseif ffi.os == "Linux" then
        ...
        libs.glx = ffi.load("GLX")
        libs.gl = ffi.load("GL")
        -- Load stb using pcall like openal
        local stb_status, stb_handle = pcall(ffi.load, "/home/frontline/SUNBURN/bin/linux_x64/libstb.so")
        libs.stb = stb_status and stb_handle or nil
